...
public class DFS {
	...
	public void ejecutar() throws IOException {
		...
		while(!pila.isEmpty()) {
			...
			for (int i = 0; i < this.cantNodos; i++) 
			{
				...
				if (nodo != i && !this.nodoTerminado[i]) 
				{
					...
					if (this.grafo.hayArista(i, nodo)) 
					{
						...
						// apilo el otro nodo de la arista para seguir recorriendo a partir de Ã©l
						pila.push(i);
						// indico que se encontrÃ³ un nodo adyacente
						adyacente = true;
			...
			// si no se encontrÃ³ algÃºn nodo adyacente
			if (!adyacente) 
			{
	...
	public void escribirSolucionEnConsola() {
		...
		/*System.out.println("DFS: BÃºsqueda en Profundidad:");
